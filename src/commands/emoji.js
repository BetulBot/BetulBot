...
class EmojiCommand extends Command {
    ...
    */
    ...
    startRemoveEmojiVote(msg, options, emojiName, url, emoji) {
        msg.channel.send(this.mention(msg.author) + " started a vote to remove following emoji:\n``:" + emojiName + ":``", options).then((message) => {
            //Start vote on message sent by the bot
            var vote = new Vote(message, this.TIME);
